/* ----- Datenbank erzeugen ----- */
DROP DATABASE IF EXISTS user_db; #Lรถsche Datenbank "user_db" falls vorhanden
...
/* ----- Tabelle Cats ----- */
DROP TABLE IF EXISTS cats; #Lรถsche Tabelle "cats" falls vorhanden
...
/* CSV-Daten parsen */
LOAD DATA LOCAL INFILE "04_SQL_data_import/cats_export_no_id.csv" INTO TABLE cats #Lade Daten in Tabelle Cats
FIELDS TERMINATED BY "," LINES TERMINATED BY "\n" #Felder werden getrennt durch ";" | Zeilen werden gertrennt durch den Umbruch "\n"
IGNORE 1 ROWS (cat_name, fur_color, age); #Die erste Zeile wird ignoriert
